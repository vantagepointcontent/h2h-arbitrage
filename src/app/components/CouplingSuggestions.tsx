...
export function CouplingSuggestions({
  ...
  return (
    <div className="rounded-xl border border-[#a855f7]/30 bg-[#17212B] overflow-hidden">
      ...
      <div className="p-4">
        {loading ? (
          <div className="flex items-center justify-center gap-2 py-6 text-sm text-[#8A9BA8]">
          ...
          <div className="text-sm text-[#8A9BA8] text-center py-4">
              ...
              return (
                ...
                >
                  ...
                  <div className="flex flex-col items-center gap-0.5 shrink-0 w-12">
                    ...
                    <span
                      className="text-[9px] text-[#8A9BA8]"
                    >
                  ...
                  <div className="hidden sm:flex flex-col gap-0.5 shrink-0 text-[9px] text-[#8A9BA8]">
