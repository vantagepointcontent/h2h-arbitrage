...
function position(executionId: number, overrides: Partial<BotPosition> = {}) {
  return {
    ...
    pmEntryFeeSchedule: { rate: 0.012, exponent: 1, takerOnly: true, rebateRate: 0.2 },
    pmEntryOrderBaseFeeBps: 400,
    pmEntryOrderFeeSource: 'https://clob.polymarket.com/fee-rate?token_id=pm-no-token',
    pmEntryOrderFeeVersion: 'token-order-base-fee:v1',
    ...
    pmExitFeeSchedule: { rate: 0.012, exponent: 1, takerOnly: true, rebateRate: 0.2 },
    pmExitOrderBaseFeeBps: 400,
    pmExitOrderFeeSource: 'https://clob.polymarket.com/fee-rate?token_id=pm-no-token',
    pmExitOrderFeeVersion: 'token-order-base-fee:v1',
