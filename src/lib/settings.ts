...
export const SETTINGS_SCHEMA: SettingDef[] = [
  ...
  { key: 'scanner.suspiciousRoiPct', section: 'scanner', label: 'Suspicious ROI threshold %', description: 'SET-003: arbs above this ROI with unknown depth are flagged suspicious and excluded from stats/alerts. Real arbs are usually 1-5%.', type: 'number', env: 'H2H_SUSPICIOUS_ROI_PCT', default: 25, min: 5, max: 200, slider: true },
  ...
  { key: 'bot.minDepthUsd', section: 'bot', label: 'Legacy fixed depth', description: 'Deprecated. Executable depth is derived from selected ask price × minimum shares.', type: 'number', default: 0.5, min: 0.01, max: 1000, hidden: true },
